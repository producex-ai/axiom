...
import { BarChart3, FileCheck, Clock, Shield, TrendingUp } from "lucide-react";
    ...
    <section className="bg-gray-50 py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {Object.keys(t.raw("primaryMetrics")).map(
            (metricKey: string, index: number) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`mb-2 font-bold text-3xl ${colorClasses.text}`}
                  >
                    {stat.value}
                  </div>
        ...
        <div className="rounded-2xl border border-emerald-100 bg-gradient-to-r from-emerald-50 to-blue-50 p-8 lg:p-12">
          <div className="grid gap-8 md:grid-cols-3">
            {Object.keys(t.raw("benefits")).map(
              (benefitKey: string, index: number) => {

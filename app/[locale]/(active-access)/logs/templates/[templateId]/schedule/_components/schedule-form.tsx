    ...
    <form action={formAction} className="space-y-6">
      ...
      <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        ...
        <div className="flex flex-wrap items-center gap-4">
          {startDate === today && (
            <div className="flex w-full items-center space-x-2 rounded-md border border-primary/20 bg-primary/5 px-3 py-2 md:w-fit">
              <Checkbox
                id="generate_today"
                name="generate_today"
                checked={generateToday}
                onCheckedChange={(checked) => setGenerateToday(!!checked)}
              />
              <Label
                htmlFor="generate_today"
